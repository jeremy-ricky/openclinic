...
<%
	String accessright="academy.chocolatose";
%>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	<td>
        		<table width='100%'>
        			<tr>
        				<td width='50%' class='admin'><%=getTran(request, "web", "quantityofhotchocolateconsumedinml", sWebLanguage) %></td>
        				<td class='admin2'><%=SH.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_CHOCOLATEQUANTITYCONSUMED", 10, sWebLanguage)%></td>
			        </tr>
			        <tr>
			        	<td width='50%' class='admin'><%=getTran(request, "web", "levelofwellbeingachieved", sWebLanguage) %></td>
			        	<td class='admin2'><%=SH.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_CHOCOLATELEVELOFBEING", "levelofwell", sWebLanguage, "") %></td>
			        </tr>
			        <tr>
			        	<td width='50%' class='admin'><%=getTran(request, "web", "lastdate", sWebLanguage) %></td>
			        	<td class='admin2'><%=SH.writeDefaultDateInput(session, (TransactionVO)transaction, "ITEM_TYPE_CHOCOLATELASTDATE", sWebLanguage, sCONTEXTPATH, false, true)%></td>
			        </tr>
        		</table>
        	</td>
        </tr>
