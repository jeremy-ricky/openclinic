        	...
        	<td colspan="2">
	        	<table width='100%'>
		        	...
		        	<tr>
			            ...
			            <td class="admin2">
			                <%=SH.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_CNTSBLOODGIFT_LOCATIONPRESET", "donationlocation",sWebLanguage,"") %><br/>
		        	...
		        	<tr>
			            ...
			            <td class="admin2">
			            	<%=SH.writeDefaultCheckBoxes((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_CNTSBLOODGIFT_PREGNANT", sWebLanguage, true, "") %>
			            </td>
			        </tr>
			        <%	} %>
		        	<tr>
