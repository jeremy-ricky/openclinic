        	...
        	<td width="50%" valign='top'>
	        	<table width='100%'>
			        ...
			        <tr>
			        	...
			        	<td class='admin2'><%=SH.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_MSAS_DECEASED_HIVPOS", "hivposoptions", "hivposoptions", sWebLanguage, "") %></td>
			        	<td class='admin'><%=getTran(request,"web","chronicdiseases",sWebLanguage)%></td>
			        	<td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_MSAS_DECEASED_CHRONICDISEASE", sWebLanguage, false, "", "") %></td>
			        </tr>
		        	<tr>
